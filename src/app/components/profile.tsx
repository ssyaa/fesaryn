...
interface ProfileProps {
  user: User;
  // optional callback kalau mau update user di parent
  onUserUpdate?: (updatedUser: User) => void;
}

export default function Profile({ user: initialUser, onUserUpdate }: ProfileProps) {
    ...
    const handleUpdate = async () => {
        ...
        const res = await axios.put("http://localhost:8000/api/user", updateData, {
            headers: {
        ...
        // update user di parent (UserPage) jika ada
        if (onUserUpdate) {
    ...
    <div className="space-y-4 max-w-5xl mx-auto mt-6 bg-white shadow-md rounded-md p-10 ">
            ...
            {[
                ...
                <div key={field}>
                    ...
                    <p className="text-gray-500">
                        {field === "password"
                        ? "•".repeat(8) // tampilkan 8 bullet atau sesuaikan jumlahnya
        ...
        <div className="space-y-4">
            ...
            { label: "Kecamatan", field: "subdistrict"},
